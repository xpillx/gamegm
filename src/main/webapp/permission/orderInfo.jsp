...
$(function(){
    ...
    function initGrid() {
    	var columns = [
          ...
          ,{title:'操作',dataIndex:'',sortable:false,width:200,renderer : function(value,obj){
    	...
    	grid = new Grid.Grid({
          	...
          	,tbar : {
              items : [
                  RightUtil.auth('btn_add',{text : '<i class="icon-plus"></i>新建',btnCls : 'button button-small',handler:add})
                  ,RightUtil.auth('btn_export',{text : '<i class="icon-download"></i>导出',btnCls : 'button button-small',handler:exportFile})
              ]
            }
          	// 底部工具栏
          	,bbar:{
