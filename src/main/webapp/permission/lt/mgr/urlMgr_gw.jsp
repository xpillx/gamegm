    ...
    <div class="container">
        ...
        <div>
            ...
            <c:if test="${title=='4'|| title=='6'}">
                <form action="http://192.168.0.1:8080/download" method="post" enctype="multipart/form-data" id="上传xml至服务器" onsubmit="formLog($(this).serialize()+'&'+'beharvior='+this.id);">
                    <div align="left">
            ...
            <c:if test="${title=='6'}">
                ...
                <a href="http://192.168.0.1:8080/snc/v1/testTool/reloadConf?type=analyticsTest" id="更新玩家行为表" name="更新玩家行为中英文对照表" hidden="true">更新</a>
