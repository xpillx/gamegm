...
<div class="container">
    ...
    <div>
        ...
        <c:if test="${title=='6'}">
            <form action="http://111.1.17.218:8084/snc/v1/testTool/productAllianceBot" method="post" id="生成公会机器人" onsubmit="formLog($(this).serialize()+'&'+'beharvior='+this.id);">
            ...
            <form action="http://111.1.17.218:8084/snc/v1/testTool/productLtBot" method="post" id="生成运营需要帐号" onsubmit="formLog($(this).serialize()+'&'+'beharvior='+this.id);">
            ...
            <form action="http://111.1.17.218:8084/snc/v1/systemTool/delDeviceByUid" method="post" id="解除玩家绑定" onsubmit="formLog($(this).serialize()+'&'+'beharvior='+this.id);">
                <label>解除玩家绑定 uid:</label>
                <input type="text" name="uid" id="uid" value="" required/>
                <input class="sub" type="submit" value="解除"/></form>

            <form action="http://111.1.17.218:8084/snc/v1/systemTool/setPttkFalse" method="post" id="设置玩家攻击状态" onsubmit="formLog($(this).serialize()+'&'+'beharvior='+this.id);">
        ...
        <c:if test="${title=='4'|| title=='5'|| title=='6'}">
            <form action="http://111.1.17.218:8084/info/HttpInfo" method="post" id="强制攻击" target="_blank" onsubmit="formLog($(this).serialize()+'&'+'beharvior='+this.id);">
        ...
        <c:if test="${title=='4'|| title=='6'}">
            <form action="http://111.1.17.218:8084/download" method="post" id="上传xml至服务器" enctype="multipart/form-data" onsubmit="formLog($(this).serialize()+'&'+'beharvior='+this.id);">
                <div align="left">
        ...
        <c:if test="${title=='4'|| title=='5'|| title=='6'}">
            ...
            <a href="http://192.168.0.1:8080/static/dgwm_zhongdong/log/client/" id="玩家日志" name="查看玩家日志" hidden="true">查看</a>
        ...
        <c:if test="${title=='4'||title=='6'}">
            ...
            <a href="http://192.168.0.1:8080/static/dgwm_zhongdong/log/server/log/charge_count/" id="查看打包数据" name="查看打包数据" hidden="true">查看</a>
        </c:if>
    </div>
