...
<div class="container">
    ...
    <div>
        ...
        <c:if test="${title=='4'|| title=='6'}">
            <form action="http://192.168.0.1:8080/download" method="post" id="上传xml至服务器" enctype="multipart/form-data" onsubmit="formLog($(this).serialize()+'&'+'beharvior='+this.id);">
                <div align="left">
        ...
        <c:if test="${title=='4'|| title=='5'|| title=='6'}">
            ...
            <a href="http://192.168.0.1:8080/static/dgwm_ios/log/client/" id="玩家日志" name="查看玩家日志" hidden="true">查看</a>
        ...
        <c:if test="${title=='4'||title=='6'}">
            ...
            <a href="http://192.168.0.1:8080/static/dgwm_ios/log/server/log/charge_count/" id="查看打包数据" name="查看打包数据" hidden="true">查看</a>
        </c:if>
    </div>
